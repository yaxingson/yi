...
function getPkgInfo() {
    return __awaiter(this, void 0, void 0, function* () {
        const pkg = yield readFile$1(resolve(ROOT_PATH, 'package.json'), 'utf-8');
...
function resolveCommandAttempt(parsed, withoutPathExt) {
    ...
    try {
        resolved = which.sync(parsed.command, {
            ...
            pathExt: withoutPathExt ? path$d.delimiter : undefined,
        });
    } catch (e) {
        /* Empty */
    } finally {
...
function readShebang$1(command) {
    ...
    try {
        fd = fs$i.openSync(command, 'r');
        fs$i.readSync(fd, buffer, 0, size, 0);
        fs$i.closeSync(fd);
    } catch (e) { /* Empty */ }
...
const signal=signals.find(({name})=>constants$3.signals[name]===number);
...
function startAction(entry) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        entry = entry || defaultEntries.find(item => lib.existsSync(resolve(CURRENT_PATH, item)));
        if (!entry)
            throw '';
...
function setCommand() {
    return __awaiter(this, void 0, void 0, function* () {
        const { version } = yield getPkgInfo();
        program.name('yi')
            .version(version)
